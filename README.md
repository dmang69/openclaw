...
Full system design, usage, operations reference, and architecture diagrams (including multi-agent orchestration, evidence/chronology expansion, and the productization layer) are in [ARCHITECTURE.md](ARCHITECTURE.md).
